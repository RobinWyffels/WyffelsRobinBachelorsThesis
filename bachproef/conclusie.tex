...
\begin{description}
    ...
    \item[DV6: Welke diagnostische methoden zijn effectief voor het isoleren van integratiefouten?] Het loggen van \texttt{map} $\to$ \texttt{odom} transformaties tijdens SLAM-events bleek essentieel. Ook "rotatietests" (draaien zonder translatie) hielpen om vast te stellen dat de fout specifiek in de lineaire translatie-as van de odometrie zat.
\end{description}
